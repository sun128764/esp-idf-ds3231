...
typedef struct ds3231* ds3231_handle_t;
...
DS3231_API int ds3231_clearInt(ds3231_handle_t driver);
...
inline static int ds3231_endTemperatureF(ds3231_handle_t driver, float *out_temperature)
{
